...
func CreateFlags(defaultPath string) []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			...
			Aliases: []string{"k"},
			Value:   "ec256",
			Usage:   "Key type to use for private keys. Supported: rsa2048, rsa3072, rsa4096, rsa8192, ec256, ec384, mldsa44, mldsa65, mldsa87.",
		},
		&cli.StringFlag{
			Name:  flgFilename,
		...
		&cli.StringFlag{
			Name:  "cert-key-type",
			Usage: "Key type for the certificate (overrides --key-type for cert only). Supported: rsa2048, rsa3072, rsa4096, rsa8192, ec256, ec384, mldsa44, mldsa65, mldsa87.",
		},
		&cli.StringFlag{
			Name: flgHTTPWebroot,
